...
//	private Adresse adresse;
	...
	public Mitarbeiter() // für Variante mit Class.forName... notwendig
	{
	}
	//---------------------------------- getter --------------------------
...
//---------------------------------- setter --------------------------
	public void setName(String name) throws PersonalException
	{
		if (name != null)
			...
			throw new PersonalException("null-Ref für setName");
	}
	public void setAdresse(String adresse) throws PersonalException
	{
		if (adresse != null)
			...
			throw new PersonalException("null-Ref für setAdresse");
	}
	public void setGeb(int geb) throws PersonalException
	{
		if (geb >= Year.now().getValue()-100 && geb <= Year.now().getValue()-15)
			this.geb = geb;
		else
			throw new PersonalException("Falsches Geburtsjahr!");
	}
	public void setEintr(int eintr)// Plausibilitätsprüfung!!!!!!!!!!!!!
	{
		this.eintr = eintr;
	}
...
//			setAdresse(zeilenTeile[2]);
	...
	public void setAll(String zeile) throws PersonalException  // Überschreiben MUSS stattfinden
	{
		try 
		{
			String[] zeilenTeile = zeile.split(";");
...
// ----------------------------------- hashcode und equals für mitarbeiter.contains()--------------------------------------
